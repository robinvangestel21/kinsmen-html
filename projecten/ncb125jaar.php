      ...
      <div class='barba-container' data-barba="container">
        <div class='project-header'>
          <div class='vimeo-video-container' id='vimeo-video-container-1'>
            <iframe id='vimeo-player-1' class='vimeo-video' src="https://player.vimeo.com/video/597073682"
              frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
            <div id='vimeo-thumb-btn-1' class='overlay-vimeo' onclick='clickedOnVimeoOverlay(1)'>
              <img src="/static/projects/NCB125jaar/1920x1080.jpg" alt="">
          ...
          <h1 class='project-title'><?php echo $lang['zlto-titel'];?></h1>
          <h1 class='project-subtitle'>ZLTO</h1>
          <p class='project-description'><?php echo $lang['zlto-tekst'];?></p>
          ...
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/NCB125jaar/01.jpg" alt="">
          </div>

          <div class='project-asset-container-img-3'>
            <img src="/static/projects/NCB125jaar/02.jpg" alt="">
            <img src="/static/projects/NCB125jaar/03.jpg" alt="">
            <img src="/static/projects/NCB125jaar/04.jpg" alt="">
          </div>

          <div class='project-asset-container-img-2'>
            <img src="/static/projects/NCB125jaar/05.jpg" alt="">
            <img src="/static/projects/NCB125jaar/06.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/NCB125jaar/07.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/NCB125jaar/Theo.jpg" alt="">
          </div>
          <div class='project-asset-container-img-2'>
            <img src="/static/projects/NCB125jaar/Jan.jpg" alt="">
            <img src="/static/projects/NCB125jaar/Joost.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/NCB125jaar/Robert.jpg" alt="">
          </div>
          <div class='project-asset-container-img-2'>
            <img src="/static/projects/NCB125jaar/Miriam.jpg" alt="">
            <img src="/static/projects/NCB125jaar/Rinus.jpg" alt="">
          </div>



          <section class='next-prev-project-buttons'>
            <a href="projecten/dottphotography" class='next'>
            ...
            <a href="/projecten/dan" class='prev'>
