      ...
      <div class='barba-container' data-barba="container">
        <div class='project-header'>
          <div class='vimeo-video-container' id='vimeo-video-container-1'>
            <iframe id='vimeo-player-1' class='vimeo-video' src="https://player.vimeo.com/video/639556942"
              frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
            <div id='vimeo-thumb-btn-1' class='overlay-vimeo' onclick='clickedOnVimeoOverlay(1)'>
              <img src="/static/projects/AdyenTechEvent/1920x1080.svg" alt="">
          ...
          <h1 class='project-title'><?php echo $lang['adyen-tech-event-titel'];?></h1>
          <h1 class='project-subtitle'>Adyen</h1>
          <p class='project-description'><?php echo $lang['adyen-tech-event-tekst'];?></p>
          ...
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/AdyenTechEvent/01.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/AdyenTechEvent/02.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/AdyenTechEvent/03.jpg" alt="">
          </div>

          <section class='next-prev-project-buttons'>
            <a href="/projecten/bataviastadfashionclub" class='next'>
            ...
            <a href="/projecten/dottphotography" class='prev'>
