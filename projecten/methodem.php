      ...
      <div class='barba-container' data-barba="container">
        <div class='project-header'>
          <div class='vimeo-video-container' id='vimeo-video-container-1'>
            <iframe id='vimeo-player-1' class='vimeo-video' src="https://player.vimeo.com/video/372875760"
              frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
            <div id='vimeo-thumb-btn-1' class='overlay-vimeo' onclick='clickedOnVimeoOverlay(1)'>
              <img src="/static/projects/MethodeM/1920x1080.svg" alt="">
          ...
          <h1 class='project-title'><?php echo $lang['methodem-titel'];?></h1>
          <h1 class='project-subtitle'>Methode M</h1>
          <p class='project-description'><?php echo $lang['methodem-tekst'];?></p>
          ...
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/MethodeM/01.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/MethodeM/02.jpg" alt="">
          </div>
          <div class='project-asset-container-img-2'>
            <img src="/static/projects/MethodeM/03.jpg" alt="">
            <img src="/static/projects/MethodeM/04.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/MethodeM/05.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/MethodeM/06.jpg" alt="">
          </div>

          <section class='next-prev-project-buttons'>
            <a href="/projecten/nvm" class='next'>
            ...
            <a href="/projecten/payvisiononboarding" class='prev'>
