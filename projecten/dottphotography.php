    ...
    <div class='barba-wrapper' data-barba="wrapper">
      <div class='barba-container' data-barba="container">
        <div class='project-header'>
          <img id="image-header" src="/static/projects/DottPhotography/1920x1080.jpg" alt="">

          <h1 class='project-title'><?php echo $lang['dott-photography-titel'];?></h1>
          <h1 class='project-subtitle'>Dott</h1>
          <p class='project-description'><?php echo $lang['dott-photography-tekst'];?></p>
          ...
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/DottPhotography/03.jpg" alt="">
          </div>
          <div class='project-asset-container-img-3'>
            <img src="/static/projects/DottPhotography/08.jpg" alt="">
            <img src="/static/projects/DottPhotography/09.jpg" alt="">
            <img src="/static/projects/DottPhotography/10.jpg" alt="">
          </div>


          <div class='project-asset-container-img-1'>
            <img src="/static/projects/DottPhotography/07.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/DottPhotography/02.jpg" alt="">
          </div>

          <div class='project-asset-container-img-2'>
            <img src="/static/projects/DottPhotography/04.jpg" alt="">
            <img src="/static/projects/DottPhotography/05.jpg" alt="">
          </div>

          <div class='project-asset-container-img-1'>
            <img src="/static/projects/DottPhotography/06.jpg" alt="">
          </div>


          <section class='next-prev-project-buttons'>
            <a href="/projecten/adyentechevent" class='next'>
            ...
            <a href="/projecten/ncb125jaar" class='prev'>
