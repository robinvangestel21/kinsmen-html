      ...
      <div class='barba-container' data-barba="container">
        <div class='project-header'>
          <div class='vimeo-video-container' id='vimeo-video-container-1'>
            <iframe id='vimeo-player-1' class='vimeo-video' src="https://player.vimeo.com/video/494128700"
              frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
            <div id='vimeo-thumb-btn-1' class='overlay-vimeo' onclick='clickedOnVimeoOverlay(1)'>
              <img src="/static/projects/aQuarantineChristmasStory/1920x1080.jpg" alt="">
          ...
          <h1 class='project-title'><?php echo $lang['christmas-titel'];?></h1>
          <h1 class='project-subtitle'>Kinsmen Collective</h1>
          <p class='project-description'><?php echo $lang['christmas-tekst'];?></p>
          ...
          <div class='project-asset-container-img-2'>
            <img src="/static/projects/aQuarantineChristmasStory/01.jpg" alt="">
            <img src="/static/projects/aQuarantineChristmasStory/03.jpg" alt="">
          </div>


          <div class='project-asset-container-img-1'>
            <img src="/static/projects/aQuarantineChristmasStory/05.jpg" alt="">
          </div>

          <div class='project-asset-container-img-2'>
            <img src="/static/projects/aQuarantineChristmasStory/Schets_Vriendin_V2.jpg" alt="">
            <img src="/static/projects/aQuarantineChristmasStory/02.jpg" alt="">
          </div>
          <div class='project-asset-container-img-2'>
            <img src="/static/projects/aQuarantineChristmasStory/Achtergronden_Sheet2.jpg" alt="">
            <img src="/static/projects/aQuarantineChristmasStory/Hoofdkarakter_Schetsen_Kerstanimatie.jpg" alt="">
          </div>
          <div class='project-asset-container-img-2'>
            <img src="/static/projects/aQuarantineChristmasStory/Profielfotos_Karakters.jpg" alt="">
            <img src="/static/projects/aQuarantineChristmasStory/Wc_Scene_Versie2.jpg" alt="">
          </div>



          <section class='next-prev-project-buttons'>
            <a href="/projecten/dott" class='next'>
            ...
            <a href="/projecten/spoorzone" class='prev'>
