      ...
      <div class='barba-container' data-barba="container">
        <div class='project-header'>
          <div class='vimeo-video-container' id='vimeo-video-container-1'>
            <iframe id='vimeo-player-1' class='vimeo-video' src="https://player.vimeo.com/video/406504624"
              frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
            <div id='vimeo-thumb-btn-1' class='overlay-vimeo' onclick='clickedOnVimeoOverlay(1)'>
              <img src="/static/projects/PayvisionCulture/1920x1080.jpg" alt="">
          ...
          <h1 class='project-title'><?php echo $lang['payvision-culture-titel'];?></h1>
          <h1 class='project-subtitle'>Payvision</h1>
          <p class='project-description'><?php echo $lang['payvision-culture-tekst'];?></p>
          ...
          <div class='project-asset-container-img-4'>
            <img src="/static/projects/PayvisionCulture/_DSC4031.jpg" alt="">
            <img src="/static/projects/PayvisionCulture/_DSC4705.jpg" alt="">
            <img src="/static/projects/PayvisionCulture/_DSC4386.jpg" alt="">
            <img src="/static/projects/PayvisionCulture/_DSC5851.jpg" alt="">
          </div>

          <div class='project-asset-container-img-2'>
            <img src="/static/projects/PayvisionCulture/_DSC3264.jpg" alt="">
            <img src="/static/projects/PayvisionCulture/_DSC3832.jpg" alt="">
          </div>

          <div class='project-asset-container-img-1'>
            <img src="/static/projects/PayvisionCulture/_DSC5942.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/PayvisionCulture/_DSC5954.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/PayvisionCulture/_DSC5978.jpg" alt="">
          </div>
          ...
          <section class='next-prev-project-buttons'>
            <a href="/projecten/payvisionmarketing" class='next'>
            ...
            <a href="/projecten/adyenpayments101" class='prev'>
