      ...
      <div class='barba-container' data-barba="container">
        <div class='project-header'>
          <div class='vimeo-video-container' id='vimeo-video-container-1'>
            <iframe id='vimeo-player-1' class='vimeo-video' src="https://player.vimeo.com/video/497564093"
              frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
            <div id='vimeo-thumb-btn-1' class='overlay-vimeo' onclick='clickedOnVimeoOverlay(1)'>
              <img src="/static/projects/Dott/1920x1080.jpg" alt="">
          ...
          <h1 class='project-title'><?php echo $lang['dott-titel'];?></h1>
          <h1 class='project-subtitle'>Dott</h1>
          <p class='project-description'><?php echo $lang['dott-tekst'];?></p>
          ...
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/Dott/Camraderie.jpg" alt="">
          </div>

          <div class='project-asset-container-img-1'>
            <img src="/static/projects/Dott/Working Smart.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/Dott/Inner Drive.jpg" alt="">
          </div>
          <div class='project-asset-container-img-3'>
            <img src="/static/projects/Dott/DSC00271.jpg" alt="">
            <img src="/static/projects/Dott/DSC00052.jpg" alt="">
            <img src="/static/projects/Dott/DSC00311.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/Dott/DSC02532.jpg" alt="">
          </div>
          <div class='project-asset-container-img-2'>
            <img src="/static/projects/Dott/DSC00033.jpg" alt="">
            <img src="/static/projects/Dott/DSC00377.jpg" alt="">
          </div>


          <section class='next-prev-project-buttons'>
            <a href="/projecten/dan" class='next'>
            ...
            <a href="/projecten/quarantinechristmas" class='prev'>
