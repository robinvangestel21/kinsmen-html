      ...
      <div class='barba-container' data-barba="container">
        <div class='project-header'>
          <div class='vimeo-video-container' id='vimeo-video-container-1'>
            <iframe id='vimeo-player-1' class='vimeo-video' src="https://player.vimeo.com/video/371645323"
              frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
            <div id='vimeo-thumb-btn-1' class='overlay-vimeo' onclick='clickedOnVimeoOverlay(1)'>
              <img src="/static/projects/AdyenAutoRescue/1920x1080.svg" alt="">
          ...
          <h1 class='project-title'><?php echo $lang['adyen-autorescue-titel'];?></h1>
          <h1 class='project-subtitle'>Adyen</h1>
          <p class='project-description'><?php echo $lang['adyen-autorescue-tekst'];?></p>
          ...
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/AdyenAutoRescue/01.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/AdyenAutoRescue/02.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/AdyenAutoRescue/03.jpg" alt="">
          </div>

          <section class='next-prev-project-buttons'>
            <a href="/projecten/payvisiononboarding" class='next'>
            ...
            <a href="/projecten/adyenloyalty" class='prev'>
