      ...
      <div class='barba-container' data-barba="container">
        <div class='project-header'>
          <div class='vimeo-video-container' id='vimeo-video-container-1'>
            <iframe id='vimeo-player-1' class='vimeo-video' src="https://player.vimeo.com/video/438813853"
              frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
            <div id='vimeo-thumb-btn-1' class='overlay-vimeo' onclick='clickedOnVimeoOverlay(1)'>
              <img src="/static/projects/AdyenGiving/1920x1080.svg" alt="">
          ...
          <h1 class='project-title'><?php echo $lang['adyen-giving-titel'];?></h1>
          <h1 class='project-subtitle'>Adyen</h1>
          <p class='project-description'><?php echo $lang['adyen-giving-tekst'];?></p>
          ...
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/AdyenGiving/01.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/AdyenGiving/02.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/AdyenGiving/03.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/AdyenGiving/04.jpg" alt="">
          </div>

          <section class='next-prev-project-buttons'>
            <a href="/projecten/adyenfootprint" class='next'>
            ...
            <a href="/projecten/parkerendenbosch" class='prev'>
