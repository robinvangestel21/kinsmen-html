      ...
      <div class='barba-container' data-barba="container">
        <div class='project-header'>
          <div class='vimeo-video-container' id='vimeo-video-container-1'>
            <iframe id='vimeo-player-1' class='vimeo-video' src="https://player.vimeo.com/video/451489118"
              frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
            <div id='vimeo-thumb-btn-1' class='overlay-vimeo' onclick='clickedOnVimeoOverlay(1)'>
              <img src="/static/projects/SpoorzoneDenBosch/1920x1080.jpg" alt="">
          ...
          <h1 class='project-title'><?php echo $lang['spoorzone-titel'];?></h1>
          <h1 class='project-subtitle'>Gemeente Den Bosch</h1>
          <p class='project-description'><?php echo $lang['spoorzone-tekst'];?></p>
          ...
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/SpoorzoneDenBosch/01.jpg" alt="">
          </div>

          <div class='project-asset-container-img-2'>
            <img src="/static/projects/SpoorzoneDenBosch/02.jpg" alt="">
            <img src="/static/projects/SpoorzoneDenBosch/03.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/SpoorzoneDenBosch/04.jpg" alt="">
          </div>

          <div class='project-asset-container-img-2'>
            <img src="/static/projects/SpoorzoneDenBosch/05.jpg" alt="">
            <img src="/static/projects/SpoorzoneDenBosch/06.jpg" alt="">
          </div>

          <section class='next-prev-project-buttons'>
            <a href="/projecten/quarantinechristmas" class='next'>
            ...
            <a href="/projecten/i3groep" class='prev'>
