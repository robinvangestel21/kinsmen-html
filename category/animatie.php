  ...
  <main class='fg'>
    ...
    <div class='filter-container' id='filter-container'>
      <div id="filter-link-container">
        ...
        <a href="/category/animatie" class='selected'><?php echo $lang['animatie']; ?></a>
    ...
    <div class='barba-wrapper' data-barba="wrapper" data-barba-namespace='work'>
      <div class='barba-container' data-barba="container">
        ...
        <section class='projects'>
          ...
          <a href="/projecten/dan" class='w-50'>
            <img src="/static/projects/Dan/743x300.svg" alt="">
            <div class='overlay'>
          ...
          <a href="/projecten/quarantinechristmas" class='w-50'>
            <img src="/static/projects/aQuarantineChristmasStory/743x300.jpg" alt="">
            <div class='overlay'>
          ...
          <a href="/projecten/spoorzone" class='w-66'>
            <img src="/static/projects/SpoorzoneDenBosch/983x300.jpg" alt="">
            <div class='overlay'>
          ...
          <a href="/projecten/i3groep" class='w-33'>
          ...
          <a href="/projecten/adyenplugins" class='w-100'>
            <img src="/static/projects/AdyenPlugins/1500x300.svg" alt="">
            <div class='overlay'>
          ...
          <a href="/projecten/adyenfootprint" class='w-20'>
            <img src="/static/projects/AdyenFootprint/297x300.svg" alt="">
            <div class='overlay'>
          ...
          <a href="/projecten/adyengiving" class='w-80'>
            <img src="/static/projects/AdyenGiving/1188x300.svg" alt="">
            <div class='overlay'>
          ...
          <a href="/projecten/parkerendenbosch" class='w-50'>
            <img src="/static/projects/ParkerenDenBosch/743x300.svg" alt="">
            <div class='overlay'>
          ...
          <a href="/projecten/nederlandsespoorwegen" class='w-50'>
            <img src="/static/projects/NederlandseSpoorwegen/743x300.jpg" alt="">
            <div class='overlay'>
          ...
          <a href="/projecten/nvm" class='w-100'>
            <img src="/static/projects/NVM/1500x300.svg" alt="">
            <div class='overlay'>
          ...
          <a href="/projecten/nvm" class='mobile-work-project-block'>
            <img src="/static/projects/NVM/503x300.svg" alt="">
            <div class='overlay'>
              <h1><?php echo $lang['nvm-titel']; ?></h1>
              <p>NVM</p>
            </div>
          ...
          <a href="/projecten/methodem" class='w-66'>
            <img src="/static/projects/MethodeM/983x300.svg" alt="">
            <div class='overlay'>
          ...
          <a href="/projecten/payvisiononboarding" class='w-33'>
          ...
          <a href="/projecten/adyenautorescue" class='w-50'>
            <img src="/static/projects/AdyenAutoRescue/743x300.svg" alt="">
            <div class='overlay'>
          ...
          <a href="/projecten/adyenloyalty" class='w-50'>
            <img src="/static/projects/AdyenLoyalty/743x300.svg" alt="">
            <div class='overlay'>
          ...
          <a href="/projecten/payvisionmarketing" class='w-100'>
            <img src="/static/projects/PayvisionMarketing/1500x300.jpg" alt="">
            <div class='overlay'>
          ...
          <a href="/projecten/klimaatneutraal" class='w-100'>
            <img src="/static/projects/KlimaatNeutraalDenBosch/1500x300.svg" alt="">
            <div class='overlay'>
          ...
          <a href="/projecten/broederliefdehelpt" class='w-100'>
            <img src="/static/projects/BroederliefdeHelpt/1500x300.jpg" alt="">
            <div class='overlay'>
