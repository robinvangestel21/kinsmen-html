      ...
      <div class='barba-container' data-barba="container">
        <div class='project-header'>
          <div class='vimeo-video-container' id='vimeo-video-container-1'>
            <iframe id='vimeo-player-1' class='vimeo-video' src="https://player.vimeo.com/video/657355267"
              frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
            <div id='vimeo-thumb-btn-1' class='overlay-vimeo' onclick='clickedOnVimeoOverlay(1)'>
              <img src="/static/projects/BataviastadFashionClub/1920x1080.jpg" alt="">
          ...
          <h1 class='project-title'><?php echo $lang['bataviastad-fashion-club-titel'];?></h1>
          <h1 class='project-subtitle'>Batavia Stad</h1>
          <p class='project-description'><?php echo $lang['bataviastad-fashion-club-tekst'];?></p>
          ...
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/BataviastadFashionClub/02.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/BataviastadFashionClub/03.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/BataviastadFashionClub/04.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/BataviastadFashionClub/06.jpg" alt="">
          </div>

          <div class='project-asset-container-img-1'>
            <img src="/static/projects/BataviastadFashionClub/13.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/BataviastadFashionClub/14.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/BataviastadFashionClub/15.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/BataviastadFashionClub/16.jpg" alt="">
          </div>
          ...
          <section class='next-prev-project-buttons'>
            <a href="/projecten/salarise" class='next'>
            ...
            <a href="/projecten/adyentechevent" class='prev'>
