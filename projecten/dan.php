      ...
      <div class='barba-container' data-barba="container">
        <div class='project-header'>
          <div class='vimeo-video-container' id='vimeo-video-container-1'>
            <iframe id='vimeo-player-1' class='vimeo-video' src="https://player.vimeo.com/video/596596117"
              frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
            <div id='vimeo-thumb-btn-1' class='overlay-vimeo' onclick='clickedOnVimeoOverlay(1)'>
              <img src="/static/projects/Dan/1920x1080.svg" alt="">
          ...
          <h1 class='project-title'><?php echo $lang['dan-titel'];?></h1>
          <h1 class='project-subtitle'>Dan.com</h1>
          <p class='project-description'><?php echo $lang['dan-tekst'];?></p>
          ...
          <div class='project-asset-container-img-2'>
            <img src="/static/projects/Dan/02.jpg" alt="">
            <img src="/static/projects/Dan/04.jpg" alt="">
          </div>

          <div class='project-asset-container-img-1'>
            <img src="/static/projects/Dan/06.jpg" alt="">
          </div>
          <div class='project-asset-container-img-2'>
            <img src="/static/projects/Dan/07.jpg" alt="">
            <img src="/static/projects/Dan/08.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/Dan/09.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/Dan/10.jpg" alt="">
          </div>



          <section class='next-prev-project-buttons'>
            <a href="/projecten/ncb125jaar" class='next'>
            ...
            <a href="/projecten/dott" class='prev'>
