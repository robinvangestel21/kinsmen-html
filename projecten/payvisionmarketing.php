      ...
      <div class='barba-container' data-barba="container">
        <div class='project-header'>
          <div class='vimeo-video-container' id='vimeo-video-container-1'>
            <iframe id='vimeo-player-1' class='vimeo-video' src="https://player.vimeo.com/video/406232341"
              frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
            <div id='vimeo-thumb-btn-1' class='overlay-vimeo' onclick='clickedOnVimeoOverlay(1)'>
              <img src="/static/projects/PayvisionMarketing/1920x1080.jpg" alt="">
          ...
          <h1 class='project-title'><?php echo $lang['payvision-marketing-titel'];?></h1>
          <h1 class='project-subtitle'>Payvision</h1>
          <p class='project-description'><?php echo $lang['payvision-marketing-tekst'];?></p>
          ...
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/PayvisionMarketing/03.jpg" alt="">
          </div>

          <div class='project-asset-container-img-2'>
            <div class='vimeo-video-container vimeo-video-asset-2' id='vimeo-video-container-2'>
              <iframe id='vimeo-player-2' class='vimeo-video' src="https://player.vimeo.com/video/406232460"
                frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
              <div id='vimeo-thumb-btn-2' class='overlay-vimeo' onclick='clickedOnVimeoOverlay(2)'>
                <img src="/static/projects/PayvisionMarketing/payment-methods.jpg" alt="">
                <div class='img-darkener'></div>
            ...
            <div class='vimeo-video-container vimeo-video-asset-2' id='vimeo-video-container-3'>
              <iframe id='vimeo-player-3' class='vimeo-video' src="https://player.vimeo.com/video/406232657"
                frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
              <div id='vimeo-thumb-btn-3' class='overlay-vimeo' onclick='clickedOnVimeoOverlay(3)'>
                <img src="/static/projects/PayvisionMarketing/smooth-payments.jpg" alt="">
                <div class='img-darkener'></div>
          ...
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/PayvisionMarketing/05.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <img src="/static/projects/PayvisionMarketing/06.jpg" alt="">
          </div>
          <div class='project-asset-container-img-1'>
            <div class='vimeo-video-container vimeo-video-asset-1' id='vimeo-video-container-4'>
              <iframe id='vimeo-player-4' class='vimeo-video' src="https://player.vimeo.com/video/356877970"
                frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
              <div id='vimeo-thumb-btn-4' class='overlay-vimeo' onclick='clickedOnVimeoOverlay(4)'>
                <img src="/static/projects/PayvisionMarketing/making-of.jpg" alt="">
                <div class='img-darkener'></div>
          ...
          <section class='next-prev-project-buttons'>
            <a href="/projecten/adyenloyalty" class='next'>
            ...
            <a href="/projecten/payvisionculture" class='prev'>
