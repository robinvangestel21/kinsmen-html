  ...
  <main class='fg'>
    ...
    <div class='filter-container' id='filter-container'>
      <div id="filter-link-container">
        ...
        <a href="/category/fotografie" class='selected'><?php echo $lang['fotografie']; ?></a>
      </div>
    ...
    <div class='barba-wrapper' data-barba="wrapper" data-barba-namespace='work'>
      <div class='barba-container' data-barba="container">
        ...
        <section class='projects'>
          <a href="/projecten/dottphotography" class='w-100'>
            <img src="/static/projects/DottPhotography/1500x300.jpg" alt="">
            <div class='overlay'>
          ...
          <a href="/projecten/payvisionculture" class='w-33'>
